      ...
      recipes: {
        ...
        createRecipe: {
          generalData: {
            ...
            pasteImageUrl: "Eller indsæt en URL til opskriftsbilledet",
            imageUrl: "Billede URL (i stedet for upload)",
            noImageChosen: "Intet billede valgt",
            uploadFileImage: "Upload billede",
          },
          tags: {
            tagsTitle: "Tags",
      ...
      recipes: {
        ...
        createRecipe: {
          generalData: {
            ...
            pasteImageUrl: "Or paste the URL for the image of the dish",
            imageUrl: "Image URL (instead of uploading)",
            noImageChosen: "No image selected",
            uploadFileImage: "Upload image",
          },
          tags: {
            tagsTitle: "Tags",
